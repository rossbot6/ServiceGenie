// lib/supabase.js
// ServiceGenie Local API Client
// This replaces the original Supabase client with a local implementation

import localApiClient from './local-api.js';

// Use local API client as the default export
