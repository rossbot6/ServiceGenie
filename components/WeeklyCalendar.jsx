...
const styles = StyleSheet.create({
  ...
  timeColumnHeader: { width: TIME_COLUMN_WIDTH, paddingVertical: 8, alignItems: 'center', justifyContent: 'flex-end', paddingBottom: 4 },
  timeColumnHeaderText: { color: '#64748b', fontSize: 10, fontWeight: '700' },
  dayHeader: { width: DAY_COLUMN_WIDTH, alignItems: 'center', paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.05)' },
